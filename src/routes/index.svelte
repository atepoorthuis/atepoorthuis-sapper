...
import pubs from './_recent_work.js'
</script>

<style>
h2 {
	@apply text-xl mt-5 mb-2 font-sans font-semibold;
}
a {
  @apply underline;
}
...
<div class="teaching">
	...
	<ul>
		...
		<li class="mb-2">⬡ Methods and Techniques of Spatial Planning (University of Amsterdam)</li>
	</ul>
</div>